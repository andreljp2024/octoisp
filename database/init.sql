...
-- Realtime v2.76.5 requires schema_migrations table with inserted_at column
-- =============================================================================
...
-- Ensure public.schema_migrations has inserted_at for gotrue compatibility
DO $$
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE schema_migrations ADD COLUMN inserted_at timestamp with time zone DEFAULT NOW();
  END IF;
END
$$;
